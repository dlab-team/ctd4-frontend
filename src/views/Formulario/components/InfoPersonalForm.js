        ...
        >
          <Form>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
              ...
              <div>
                <h3>¿Cuál o cuáles cargos te gustaría optar?</h3>
                <p>
                  Ten en cuenta: De acuerdo al cargo que postules, te pediremos
                  que seas capaz de demostrarlo de manera práctica durante el
            ...
            <div className="mt-12">
              ...
              <div className="mt-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3">
                  <div>
                    <h3 className="font-bold">Lenguaje nivel 1:</h3>
                    <Checkbox
                      name="languageLevel1"
                      value="python"
                      label="Python"
                  ...
                  <div>
                    <h3 className="font-bold">Bases o frameworks nivel 1:</h3>
                  ...
                  <div>
                    <h3 className="font-bold">Herramientas nivel 1:</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3">
                <div>
                  <h3 className="font-bold">Lenguaje nivel 2:</h3>
                ...
                <div>
                  <h3 className="font-bold">Bases o frameworks nivel 2:</h3>
                ...
                <div>
                  <h3 className="font-bold">Herramientas nivel 2:</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3">
                <div>
                  <h3 className="font-bold">Lenguaje nivel 3:</h3>
                ...
                <div>
                  <h3 className="font-bold">Bases o frameworks nivel 3:</h3>
                ...
                <div>
                  <h3 className="font-bold">Herramientas nivel 3:</h3>
            ...
            <button type="submit" className="btn py-3 mt-5">
              Guardar
            </button>
          </Form>
        </Formik>
